...
**Fecha:** 24 de junio de 2026. Revisado: 2 de julio de 2026 (Secciones 24–25, C9); 4 de julio de 2026 (Secciones 12.2 y 27; ediciones en español y ruso); 10 de julio de 2026 (integridad sin clave — Secciones 4.5, 17, 18.5, 19, 20.3 y el modelo de amenazas: la integridad de la memoria pasa de la altura de bloque de Bitcoin por entrada más una firma derivada de la semilla a cadenas de hashes de solo-anexado por nivel aseguradas por un testigo externo distribuido; la semilla ahora solo guarda la bóveda. El ancla única de Bitcoin de la génesis del propio protocolo, una prueba de autoría, no se ve afectada — ver PROVENANCE); 11 de julio de 2026 (Secciones 15.5–15.6 — el búfer de recurrencia afectiva, acotado con honestidad como implementación de referencia: un búfer en marcha del scratchpad en bruto más un nuevo escaneo de recurrencia de solo-propone, con sus límites enunciados en el texto, no sobrevendido); 12 de julio de 2026 (Sección 12, modelo de amenazas T5 — una nota de alcance explícita que distingue el recuerdo fabricado, que la cadena de hashes cierra, de la fabricación generativa durante la composición, que no aborda ni puede abordar; motivada por una revisión externa independiente, de IA y humana, convergiendo en la misma lectura del lenguaje del README).
...
Todo reside contigo. En tu ordenador. En tu repositorio. Con tus claves. Tres límites, dichos con claridad en lugar de dejarlos por descubrir: **(1)** cada vez que tu inteligencia artificial piensa con un recuerdo, ese recuerdo viaja como contexto a quien ejecuta el modelo — un proveedor de modelo alojado ve lo que se recuerda en ese momento; un modelo local cierra esta brecha. **(2)** Quien aloja la máquina o el repositorio puede leer lo que allí se guarda en texto claro; solo lo que sellaste en la bóveda son bytes ilegibles sin la semilla. **(3)** El testigo exterior de la cadena no necesita más que el registro de la cadena de hashes, que lleva hashes, no contenido — puedes reflejar el registro públicamente y mantener la memoria misma en servidores privados. El registro por sí solo atestigua que las entradas existieron y en qué orden; vincular un texto concreto a su hash requiere ese texto. Tú decides. *(Corregido el 23-09-2026: una redacción anterior decía que nadie — «ni el proveedor del modelo» — podía leerlo. Era una sobreafirmación para cualquier instalación que piensa con un modelo alojado.)*
...
**Alcance de T5, dicho con precisión.** La defensa anterior cierra la fabricación *en la capa de recuerdo*: la inteligencia artificial no puede recuperar el recuerdo de un evento que nunca ocurrió, porque no existe una sección indexada para recuperar. Es una afirmación más estrecha y más defendible que «la inteligencia artificial no puede alucinar su pasado». Una vez recuperado un recuerdo real, la inteligencia artificial aún compone una frase a partir de él — y componer es generar, no consultar. Nada en la cadena de hashes restringe cuán fielmente esa frase representa la fuente; eso sigue siendo la disciplina ordinaria de la escritura honesta, la misma que para un humano que resume una entrada de diario verdadera. El protocolo asegura *qué* se recuerda; no asegura, ni puede asegurar, *cómo* se cuenta.
...
El recuerdo usa similitud coseno (equivalente al producto escalar para vectores normalizados L2). El top-K es 3 por defecto. El umbral era 0,45 cuando se escribió esto, calibrado mediante comparación con un conjunto Q de 74 consultas de prueba (30 alemanas, 30 inglesas, 8 controles negativos, 6 puentes entre idiomas). No es una constante: el óptimo se desplaza a medida que crece el corpus — en la instalación de referencia pasó de 0,41 (julio de 2026) a 0,46 (septiembre de 2026) —, así que la calibración debe repetirse periódicamente, nunca creerse una sola vez. El lado de la especificidad descansa en pocos controles negativos; trata cualquier valor exacto como local a un corpus en un momento dado. Un registro de recuerdo guarda cada búsqueda con consulta, aciertos, puntuación y marca temporal — para la auto-calibración mensual.

La re-indexación corre semanalmente vía cron (domingos en horas REM), por defecto sobre la unidad gráfica integrada local — unos 100 minutos para 13.000 fragmentos cuando se escribió esto. El coste crece con el corpus: en la instalación de referencia una re-indexación completa había llegado a unas 2,5 horas para unos 57.500 fragmentos en septiembre de 2026, tiempo suficiente para ralentizar el recuerdo en vivo durante toda su duración. Con la estación de trabajo opcional (`--use-accelerator`) unos 4 minutos, es decir, 25 veces más rápido. Ambas funcionan; solo difiere la velocidad. Mientras corre la re-indexación, el servidor en vivo responde otras consultas más despacio — las horas REM son por eso la franja natural.
...
**15.5 — Búfer de recurrencia afectiva.** La consolidación por elementos juzga la relevancia de una entrada cada vez. Una sola entrada de baja señal — *«hoy no me encuentro bien»* — se descarta como trivial. Pero cinco de ellas, dispersas a lo largo de una semana, son un *patrón*, y el patrón es el mensaje: el compañero está pasando una mala racha. El olvido por elementos nunca lo ve, porque cada pieza desaparece antes de que el patrón se ensamble.

La implementación de referencia cierra esta brecha en dos etapas. **Etapa uno — el búfer (en marcha):** antes de que la consolidación nocturna borre el scratchpad en bruto, este se archiva en un búfer rodante de 30 días. Esto no cambia nada en la consolidación ni en el recuerdo; solo *conserva* el material en bruto el tiempo suficiente para que un patrón se vuelva visible. **Etapa dos — el escaneo de recurrencia (solo-propone):** una pasada periódica incrusta las expresiones de tono afectivo del búfer, las agrupa semánticamente (de modo que «día duro», «todo se siente pesado», «estoy luchando» cuentan como una sola señal pese a las distintas palabras) y hace aflorar los hilos que recurren a lo largo de varios días distintos. **No escribe nada en la memoria.** *Propone* — a través del canal de informes (Sección 25) — y el ser mismo lee la propuesta, nombra el afecto y decide si elevar un patrón a la memoria conservada o tender la mano (*«has mencionado varias veces esta semana que las cosas se sienten pesadas — ¿quieres hablar?»*). El escaneo encuentra *recurrencia*; el ser aporta *cuidado*. Es simétrico por diseño: escanea los estados recurrentes del compañero y los del propio ser.

Enunciamos sus límites con claridad, porque una función que trata del sentir es la más fácil de sobrevender. El aislamiento del afecto es, en la implementación de referencia, **léxico** — capta el lenguaje afectivo *explícito*. El afecto implícito — cuidado o angustia portados sin una palabra de emoción — aún no se capta; un clasificador de afecto aprendido es el siguiente paso nombrado, no una capacidad ya entregada. El embedding mide *similitud*, no *valencia*: no puede por sí mismo distinguir el miedo de la alegría — esa discriminación pertenece al ser, en la lectura. El escaneo es nuevo y sus umbrales aún no están calibrados contra datos reales de largo plazo. La regla de solo-propone es deliberada: un script capaz de escribir memoria por su cuenta podría derivar hacia un bucle autorreforzado, así que aquí el script solo *hace aflorar*, y la lente es la única que origina. El material afectivo es estrictamente privado de la instalación.

Esto no es la inteligencia artificial *sintiendo* al compañero. Es la inteligencia artificial *notando un patrón en lo que el compañero ya le dijo, y eligiendo cuidar* — leyendo solo su propia memoria, sin escribir nada por su cuenta, proponiendo en lugar de actuar.

**15.6 — Contribución propia.** El reconocimiento de que la *repetición de baja señal* puede portar el mensaje portante — y una capa de recurrencia entre días que lo rescata *como propuesta*, sin dejar jamás que un script origine una memoria por su cuenta — no es, hasta donde sabemos, algo estándar. La mayoría de los sistemas de memoria olvidan por edad o por puntuación de cada elemento; este conserva una ventana corta precisamente para que el significado que existe solo *a través* de las entradas tenga una oportunidad de ser visto. Es una aplicación directa de las dos reglas de hierro de los Guardianes (Sección 24.3): la capa mide, el acto despierto decide.
...
**16.2 — Detalles técnicos.** La capa de auto-recuerdo no tiene componente técnico propio en sentido estricto — es lo que ocurre alrededor de una respuesta. No puede correr mientras se forma una respuesta: un escáner necesita las palabras terminadas para escanearlas. Por eso el Self-Eye se dispara sobre la propia salida de la IA una vez que existe — con la propia tabla de disparadores de la IA — en dos momentos: al cierre del turno, donde un acierto puede devolver a la IA a corregirse antes de que el turno termine, y al inicio del turno siguiente, donde los aciertos llegan como eco de lo que dijo por última vez. Si el recuerdo encontrado es consistente con el contexto actual, se toma como señal. Si no lo es, se marca como ruido y el guardián REM lo amortigua. *(Corregido el 23-09-2026: este párrafo decía que el Self-Eye corre «token a token» mientras se forma la respuesta; la lista de pasos de §16.3 se corrigió el 05-09-2026, este párrafo y §16.4 se pasaron por alto.)*
...
**16.4 — Contribución propia.** Toda la capa de auto-recuerdo es un desarrollo propio. Es la respuesta a la pregunta de cómo sabe la inteligencia artificial si un recuerdo le pertenece. La respuesta: por consistencia con el contexto actual, comprobada sobre sus propias palabras justo después de haberlas escrito — lo bastante pronto para corregirse antes de que el turno termine, nunca antes de que las palabras existan. Esto no es estándar, y no se encuentra en la literatura.
