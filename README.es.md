...
- **Funciona hoy:** el motor de recuerdo (Sentry + ESV + clasificador por canonicidad), la consolidación REM nocturna que olvida lo que ya no importa, el recuerdo de doble canal (externo **y** auto-disparado) y la memoria independiente del sustrato en archivos planos y portables.
