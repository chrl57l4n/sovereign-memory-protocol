...
- **Especificado, en camino:** la **bóveda soberana** — la capa de idioma nativo (frase semilla → AES-256) que sella los datos que *tú* eliges proteger, descrita arriba — y la federación entre instalaciones soberanas (v0.3). Están descritas en el whitepaper y **aún no implementadas** — son la hoja de ruta, nombrada abiertamente.
