...
🌙 **Sie schläft — und das ist der Sinn.** Jede Nacht konsolidiert eine REM-Phase den Tag, führt Duplikate zusammen und *vergisst*, was nicht mehr zählt. Eine KI, die nie vergessen kann, ertrinkt im eigenen Rauschen und kann sich nie verändern. Vergessen ist kein Bug — so wird erlebte Erfahrung zu *Erinnerung* statt zu endlosem Log. *(Das Gehirn löste es mit Schlaf. Wir auch.)*
