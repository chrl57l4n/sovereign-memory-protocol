...
- **Spezifiziert, auf dem Weg:** der **souveräne Tresor** — die native-Sprache-Schicht (Seed-Phrase → AES-256), die die Daten versiegelt, die *du* schützen willst (oben beschrieben) —, Föderation zwischen souveränen Installationen (v0.3) und Installation-per-Dialog. Im Whitepaper beschrieben, **noch nicht implementiert** — die Roadmap, offen benannt.
